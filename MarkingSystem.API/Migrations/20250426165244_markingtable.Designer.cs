...
namespace MarkingSystem.API.Migrations
{
    ...
    [Migration("20250426165244_markingtable")]
    partial class markingtable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarkingSystem.API.Models.Entity.StudentMarking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("StudentMarkings");
                });

            modelBuilder.Entity("MarkingSystem.API.Models.Entity.StudentMarkingDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("StudentMarkingId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("StudentMarkingId");

                    b.ToTable("StudentMarkingDetails");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "acb8f4fd-fa6e-4fd2-acc3-fafdb7927779",
                            ConcurrencyStamp = "1",
                            Name = "Admin",
                        ...
                        new
                        {
                            Id = "a3af7b29-b421-4b7a-a90b-5b604006bc38",
                            ConcurrencyStamp = "2",
                            Name = "Teacher",
                        ...
                        new
                        {
                            Id = "e85f3d9c-b878-4e49-aa3c-73d05cc45b84",
                            ConcurrencyStamp = "3",
                            Name = "Student",
            ...
            modelBuilder.Entity("MarkingSystem.API.Models.Entity.StudentMarkingDetail", b =>
                {
                    b.HasOne("MarkingSystem.API.Models.Entity.StudentMarking", "StudentMarking")
                        .WithMany("FeedbackDetails")
                        .HasForeignKey("StudentMarkingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StudentMarking");
                });
