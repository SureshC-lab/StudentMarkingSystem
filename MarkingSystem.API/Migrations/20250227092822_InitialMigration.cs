    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FinalMarkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PeerMarks = table.Column<double>(type: "float", nullable: false),
                    TeacherMarks = table.Column<double>(type: "float", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinalMarks_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PeerAssignments_AspNetUsers_PeerId",
                        column: x => x.PeerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PeerAssignments_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PeerAssignments_TimeSlots_SlotId",
                        column: x => x.SlotId,
                        principalTable: "TimeSlots",
                        principalColumn: "TimeSlotId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TeacherMarkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SlotId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeacherMarks", x => x.TeacherMarkId);
                    table.ForeignKey(
                        name: "FK_TeacherMarks_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TeacherMarks_TimeSlots_SlotId",
                        column: x => x.SlotId,
                        principalTable: "TimeSlots",
                        principalColumn: "TimeSlotId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PeerMarkId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PeerAssignmentId = table.Column<int>(type: "int", nullable: false),
                    RubricCriteriaId = table.Column<int>(type: "int", nullable: false),
                    Score = table.Column<int>(type: "int", nullable: false),
                    IsInvalidMarking = table.Column<bool>(type: "bit", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PeerMarks", x => x.PeerMarkId);
                    table.ForeignKey(
                        name: "FK_PeerMarks_PeerAssignments_PeerAssignmentId",
                        column: x => x.PeerAssignmentId,
                        principalTable: "PeerAssignments",
                        principalColumn: "PeerAssignmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PeerMarks_RubricCriteria_RubricCriteriaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PeerAssignments_PeerId",
                table: "PeerAssignments",
                column: "PeerId");

            migrationBuilder.CreateIndex(
                name: "IX_PeerAssignments_SlotId",
                table: "PeerAssignments",
                column: "SlotId");

            migrationBuilder.CreateIndex(
                name: "IX_PeerAssignments_StudentId",
                table: "PeerAssignments",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_PeerMarks_PeerAssignmentId",
                table: "PeerMarks",
                column: "PeerAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PeerMarks_RubricCriteriaId",
                table: "PeerMarks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherMarks_SlotId",
                table: "TeacherMarks",
                column: "SlotId");

            migrationBuilder.CreateIndex(
                name: "IX_TeacherMarks_StudentId",
                table: "TeacherMarks",
                column: "StudentId");
        }
